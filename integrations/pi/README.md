...
This extension reports Pi agent lifecycle events to the S-Term tab that contains Pi. It also adds whole-draft cursor navigation and S-Term image-paste handling.
